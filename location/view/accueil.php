...
<body>
    ...
    <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="image\1.JPG" class="d-block w-100" alt="image is here ">
            ...
            <div class="carousel-item">
                <img src="image\2.png" class="d-block w-100" alt="image is here">
                <div class="carousel-caption d-none d-sm-block carl">
                    <h3>MATERIELS AGRICULTURE : COMMANDEZ AU MEILLEUR PRIX !</h3>
                    <p>Nos agents sont à votre disposition dans toute la Tunisie Louer des matériels agricole en ligne
                        en Tunisie
            ...
            <div class="carousel-item">
                <img src="image\3.JPEG" class="d-block w-100" alt="image is here">
                <div class="carousel-caption d-none d-sm-block carl">
                    <h3>MATERIELS AGRICULTURE : COMMANDEZ AU MEILLEUR PRIX !</h3>
                    <p>Nos agents sont à votre disposition dans toute la Tunisie Louer des matériels agricole en ligne
                        en Tunisie
    ...
    <section id="propos">
        ...
        <img class="iconetracteur" src="image/4.JPEG" alt="image4">
        <div class="parag2">
    ...
    <section class="materiel"> <br>
        ...
        <h3 class="titre1">Maison et Villa</h3>
        <div class="bloc2"></div> <br>
        <div class="galerie">
        ...
        <div class="galerie">
            <img src="image/6.JPEG" alt="image6">
            <p> Matériel de récolte </p>
        </div>

        <div class="galerie">
            <img src="image/7.jpg" alt="image7">
            <p> Sémoirs </p>
        </div>

        <div class="galerie">
            <img src="image/8.jpeg" alt="image8">
            <p> Pulvérisateurs </p>
        </div>

        <div class="galerie">
            <img src="image/9.JPEG" alt="image9">
            <p> Outil du sol animé </p>
        </div>

        <div class="galerie">
            <img src="10.JPEG" alt="image10">
