                ...
                <div class="form-group input-group-sm">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <option value="Selection"> Sélectionner une Categorie</option>
                <option value="Villas "> Villas </option>
                <option value="Appartements ">Appartements </option>
                <option value="Maisons de vacances"> Maisons de vacances</option>
                <option value="Chalets ">Chalets </option>
                <option value="Maisons de ville">Maisons de ville</option>
                <option value="Bungalows">Bungalows</option>
                <option value="Maisons de campagne">Maisons de campagne</option>
